...
def draw_2D_vector(x,y,name):
	...
	x2 = 1.15 * x
	y2 = 1.15 * y
	plt.text(x2,y2,name,fontsize=16)
...
def draw_real_part():
	...
	# drawing |0>
	plt.plot(1,0,"o")
	plt.text(1.05,0.05,"|0>",fontsize=fsize)
	# drawing |1>
	plt.plot(0,1,"o")
	plt.text(0.05,1.05,"|1>",fontsize=fsize)
...
def draw_real_part2():
	...
	# drawing |+>
	plt.plot(1,0,"o")
	plt.text(1.05,0.1,"$ (|0>+|1>)/\sqrt{2} $",fontsize=fsize)
	# drawing |0>
	plt.plot(0,1,"o")
	plt.text(0.05,1.1,"|0>",fontsize=fsize)
	# drawing |1>
	plt.plot(0,-1,"o")
	plt.text(0.05,-1.15,"|1>",fontsize=fsize)
...
def draw_imaginary_part():
	...
	# drawing 1
	plt.plot(1,0,"o")
	plt.text(1.05,0.05,"1",fontsize=fsize)
	# drawing i
	plt.plot(0,1,"o")
	plt.text(0.05,1.05,"i",fontsize=fsize)
	# drawing -1
	plt.plot(-1,0,"o")
	plt.text(-1.2,-0.15,"-1",fontsize=fsize)
	# drawing -i
	plt.plot(0,-1,"o")
	plt.text(-0.2,-1.15,"-i",fontsize=fsize)